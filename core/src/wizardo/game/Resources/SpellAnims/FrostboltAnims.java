...
public class FrostboltAnims {
    ...
    public static String frostbolt_projectile_atlas_path = "Spells/Frostbolt/Frostbolt_Projectile.atlas";
    ...
    public static void loadAnimations() {
        TextureAtlas proj_atlas = assetManager.get(frostbolt_projectile_atlas_path, TextureAtlas.class);
        ...
        frostbolt_anim_frost = new Animation<>(0.03f, bolt_frames);
    ...
    public static void loadAtlas() {
        assetManager.load(frostbolt_projectile_atlas_path, TextureAtlas.class);
