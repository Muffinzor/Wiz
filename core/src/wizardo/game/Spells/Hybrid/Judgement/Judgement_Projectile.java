...
public class Judgement_Projectile extends Judgement_Spell {
    ...
    public boolean hasArrived() {
        ...
        return Math.abs(dst) < 0.35;
    }

    public void explode() {
        Judgement_Trigger_Explosion explosion = new Judgement_Trigger_Explosion(targetPosition);
        ...
        if(ministorm) {
            ...
            storm.duration = 1.5f + 0.5f * player.spellbook.arcanemissile_lvl;
